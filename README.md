...
XML.au3 is an AutoIt UDF for reading and writing XML documents using MSXML.

This repository currently contains the latest version publicly available from the AutoIt Forum Downloads entry for **XML.au3 (formerly XMLWrapperEx.au3)**:
